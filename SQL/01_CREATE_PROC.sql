...
set @sql =
'bcp "SELECT E.EMPLOYEE_NAME,E.SURNAME,E.PATRONYMIC,E.BIRTHDATE,E.PASSPORT_SERIES,E.PASSPORT_NUMBER,C.COMPANY_NAME FROM APPS_DB.DEPO.EMPLOYEES AS E LEFT JOIN APPS_DB.DEPO.COMPANIES AS C ON E.COMPANY_ID = C.COMPANY_ID" queryout D:\MyTemp\EMPLOYEES_full.csv -c -t^| -T -S ' + @@SERVERNAME 
